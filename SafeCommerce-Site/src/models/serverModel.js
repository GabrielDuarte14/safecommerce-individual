...
function registerServer(model, os, cpuAmount, ramMemory, diskAmount, idCompany) {
    console.log("ACESSEI O SERVER MODEL \n \n\t\t >> Se aqui der erro de 'Error: connect ECONNREFUSED',\n \t\t >> verifique suas credenciais de acesso ao banco\n \t\t >> e se o servidor de seu BD está rodando corretamente. \n\n function registerServer(): ", model, os, cpuAmount, ramMemory, diskAmount, idCompany);
    var instruction = 
    `
    INSERT INTO servidor (modelo, SO, qtd_cpus, qtd_memoria_ram, qtd_disco, fkEmpresa) VALUES ('${model}', '${os}', '${cpuAmount}', '${ramMemory}', '${diskAmount}', '${idCompany}');
    `
